...
#include <asm/intel_mid_rpmsg.h>
/*Ryant Add for ATD Start*/
#include <linux/mmc/host.h>
#include <linux/mmc/card.h>
#include <linux/mmc/mmc.h>
#include <linux/mmc/sd.h>
/*Ryant Add for ATD End*/
#include "sdhci.h"
...
static ssize_t eMMC_total_size(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    if (!chip || ((pdev->device != PCI_DEVICE_ID_INTEL_BYT_EMMC45)&&
				(pdev->device != PCI_DEVICE_ID_INTEL_BYT_EMMC))  ){
        return 0;
	}
...
static DEVICE_ATTR(emmc_status, S_IRUGO, eMMC_name_check, NULL);
