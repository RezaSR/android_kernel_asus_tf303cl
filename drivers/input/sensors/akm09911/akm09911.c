...
struct acpi_device_id akm9911_acpi_match[] = {
		{AKM_I2C_NAME,0},
};

MODULE_DEVICE_TABLE(acpi,akm_compass_id);
...
static struct akm09911_platform_data akm_platform_data_09911 = {
		.gpio_RSTN = 0,
		.layout = 7
};


static struct i2c_board_info __initdata akm9911_boardinfo[] = {
		{
				I2C_BOARD_INFO(AKM_I2C_NAME,0x0D),
				.flags = I2C_CLIENT_WAKE,
				.platform_data = &akm_platform_data_09911,
				.irq = 0,
		}
};
...
//	printk("akm  :init register i2c bus++ /n");
//	i2c_register_board_info(5,akm9911_boardinfo,
//	ARRAY_SIZE(akm9911_boardinfo));
//	printk("akm :init register i2c bus-- /n");
